...
public class SettingsWindow extends JDialog {
    ...
    public SettingsWindow(JFrame owner) {
        ...
        okButton = createOkButton(layout);
    ...
    public void setGameTypeChoiceListener(ActionListener gameTypeChoiceListener) {
        okButton.addActionListener(gameTypeChoiceListener);
    }
